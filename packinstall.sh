...
mkdir -p ~/.config/{hypr,waybar,dunst,rofi,alacritty,kitty}
mkdir -p ~/.local/bin
...
echo "2. Configure your shell: chsh -s /usr/bin/zsh"
echo "3. Set up your Git configuration: git config --global user.name/user.email"
echo "4. Install additional AUR packages as needed"
echo "5. Customize your Hyprland, Waybar, and other configurations"
echo "6. Update your system: sudo pacman -Syu"
echo "7. Source your Rust environment: source ~/.cargo/env"
